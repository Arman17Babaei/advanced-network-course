...
Now that you've thought about where your students are starting from, it's time to define the destination: the learning outcomes.

- By the time your students complete this learning experience...
  - What should they be able to **do**?
  - What should they **know** and **understand**?
  - What should their **opinions** be about these topics?
- Are there topics that you’d like to 1) retire or 2) promote given AI’s capabilities?

Write your learning outcomes by completing this prompt:

> **By the time students finish the learning experience, they should be able to [ACTIVE VERB]...**

The target depth below uses the revised Bloom taxonomy: **Remember → Understand → Apply → Analyze → Evaluate → Create** (Anderson & Krathwohl, 2001, revising Bloom et al., 1956).
...
**Retire:** Treating protocol/tool implementation, simulation, or configuration as an end in itself or as the highest cognitive demand of a semester project. AI can perform much of this work, so implementation should serve a larger design and experimental argument.
...
- Biggs, J. (1996), “Enhancing teaching through constructive alignment,” *Higher Education*, 32, 347–364. The assessment design should require the same level of cognitive activity stated in these outcomes.
