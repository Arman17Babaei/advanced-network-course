...
Now it’s time to decide what evidence students will produce to show they’ve achieved the learning outcomes. Fill out the table below to plan your assessments:

- **Aligned Learning Outcome(s):** Copy/paste a learning outcome from [2. Learning Outcomes](02_LEARNING_OUTCOMES.md). The assessment will measure whether your students have achieved that specific learning outcome.
- **Assessment Task(s):** Fill in this column by completing the prompt, *“Students will show that they’ve achieved the learning outcome(s) by...”*
...
| --- | --- | --- |
| _TODO_ | _TODO_ | _Require / Allow / Ban_ |
| _TODO_ | _TODO_ | _Require / Allow / Ban_ |
| _TODO_ | _TODO_ | _Require / Allow / Ban_ |
| _TODO_ | _TODO_ | _Require / Allow / Ban_ |
| _TODO_ | _TODO_ | _Require / Allow / Ban_ |
...
The final presentation sessions should expose students to the design spaces of the other projects, including how the importance of particular domains and design aspects rises or falls with workload and system constraints. The individual exam should then verify that each student has a working grasp of the architecture and major design decisions of all presented projects, rather than only the project their own team built.
...
The matrix intentionally combines **positive interdependence** with **individual accountability**, concepts developed in cooperative-learning research (e.g., Johnson & Johnson, 2009, “An Educational Psychology Success Story: Social Interdependence Theory and Cooperative Learning,” *Educational Researcher*). The course still needs an individual assessment because successful team output alone does not establish each student’s understanding.
